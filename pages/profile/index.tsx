      ...
      <div className="px-4">
        ...
        <div className="mt-12">
          ...
          <div className="mt-4 text-gray-600 text-sm">
            <p>
              abc abcabcabc abc abc abcabcabc abc abc abcabcabc abc abc
              abcabcabc abc abc abcabcabc abc abc abcabcabc abc abc abcabcabc
              abc abc abcabcabc abc abc abcabcabc abc abc abcabcabc abc abc
              abcabcabc abc abc abcabcabc abc
            </p>
          </div>
        </div>
      </div>
